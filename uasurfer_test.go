...
var testUAVars = []struct {
	...
	{"Apache-HttpClient/4.5.2 (Java/1.8.0_20)",
		UserAgent{
			Browser{BrowserUnknown, Version{4, 5, 2}, "apache-httpclient", ""}, OS{PlatformUnknown, OSUnknown, Version{0, 0, 0}}, DeviceUnknown}},
	...
	{"Roku/DVP-5.2 (025.02E03197A)", // Roku
		UserAgent{
			Browser{BrowserUnknown, Version{0, 0, 0}, "roku", ""}, OS{PlatformUnknown, OSUnknown, Version{0, 0, 0}}, DeviceTV}},
	...
	{"Microsoft-CryptoAPI/10.0",
		UserAgent{
			Browser{BrowserUnknown, Version{10, 0, 0}, "microsoft-cryptoapi", ""}, OS{PlatformWindows, OSUnknown, Version{0, 0, 0}}, DeviceComputer}},
	{"trustd (unknown version) CFNetwork/811.7.2 Darwin/16.7.0 (x86_64)",
		UserAgent{
			Browser{BrowserUnknown, Version{811, 7, 2}, "trustd (unknown version) cfnetwork", ""}, OS{PlatformMac, OSUnknown, Version{0, 0, 0}}, DeviceComputer}},
	{"ocspd (unknown version) CFNetwork/520.5.3 Darwin/11.4.2 (x86_64)(MacBookAir5%2C2)",
		UserAgent{
			Browser{BrowserUnknown, Version{520, 5, 3}, "ocspd (unknown version) cfnetwork", ""}, OS{PlatformMac, OSUnknown, Version{0, 0, 0}}, DeviceComputer}},
	// Bots
	...
	{"Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1 (compatible; Baiduspider-render/2.0; +http://www.baidu.com/search/spider.html)",
		UserAgent{
			Browser{BrowserBaiduBot, Version{0, 0, 0}, "", ""}, OS{PlatformBot, OSBot, Version{9, 1, 0}}, DeviceComputer}},
	...
	{"Sogou web spider/4.0(+http://www.sogou.com/docs/help/webmasters.htm#07)",
		UserAgent{
			Browser{BrowserSogouBot, Version{0, 0, 0}, "", ""}, OS{PlatformBot, OSBot, Version{0, 0, 0}}, DeviceComputer}},
	...
	for _, determined := range testUAVars {
		t.Run("", func(t *testing.T) {
			...
			for _, f := range testFuncs {
				...
				if ua.Browser.NameStr != determined.Browser.NameStr {
					t.Errorf("browserNameStr: got %v, wanted %v", ua.Browser.NameStr, determined.Browser.NameStr)
					t.Logf("agent: %s", determined.UA)
				}

				if ua.Browser.Url != determined.Browser.Url {
					t.Errorf("browserUrl: got %v, wanted %v", ua.Browser.Url, determined.Browser.Url)
					t.Logf("agent: %s", determined.UA)
				}
